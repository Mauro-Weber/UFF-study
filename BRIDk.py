...
for key in knn_dictionary:
    ...
    lista_value.append(str(knn_dictionary[key][0]))
    
dict_dataframe = spark.createDataFrame(zip(lista_key,lista_value), schema=['point', 'knn_points'])

dict_dataframe.write.csv("bridkresults.csv")
